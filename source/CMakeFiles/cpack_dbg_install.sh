...
OUTDIR=${DESTDIR}/usr/WorkDir/21.2.68/InstallArea/x86_64-centos7-gcc62-opt
...
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.11.0/Linux-x86_64/bin/cmake -E copy /home/rushioda/AthTutorial/source/x86_64-centos7-gcc62-opt/bin/*.dbg \
    ${OUTDIR}/bin/
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.11.0/Linux-x86_64/bin/cmake -E copy /home/rushioda/AthTutorial/source/x86_64-centos7-gcc62-opt/lib/*.dbg \
    ${OUTDIR}/lib/
