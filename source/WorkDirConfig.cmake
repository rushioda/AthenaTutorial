...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 21.2.68)" )
endif()
...
set( WorkDir_BASE_PROJECTS AthAnalysis;21.2.68 )
...
set( WorkDir_PACKAGE_NAMES MyPackage )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES MyPackagePkg;MyPackagePkgPrivate;MyPackageLib;MyPackage )
